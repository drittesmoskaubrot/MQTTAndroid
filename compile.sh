...
$TOOLCHAIN -fPIC -pie -I src  -L lib --sysroot=$PLATFORM -o lib/MQTTVersion -lpaho-mqtt3c src/MQTTVersion.c -ldl

$TOOLCHAIN -fPIC -pie --sysroot=$PLATFORM -o $1 $2   -I src  -L lib -lpaho-mqtt3c
